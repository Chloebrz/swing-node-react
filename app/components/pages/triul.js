...
const Triul = () => {
    return (
        <div>
            ...
            <p>
                La S'Wing est l'aboutissement de plusieurs projets destinés à éliminer ou réduire
                les inconvénients des voiliers actuels grâce à l'auto-orientation de la voilure. Le
                concept utilisé sur le Triul, projet précédent, était dérivé de l'équilibre
                aérodynamique des avions et planeurs tel que défini par Voisin : "Centre de gravité
                en avant du centre de voilure, et empennage horizontal arrière inversé", (transposé
                à 90 degrés pour le Triul).
            </p>
            <p>
                La S'Wing utilise les conditions d'équilibre aérodynamique du parapente, transposées
                du plan vertical au plan horizontal. Cette option permet d'alléger le dispositif en
                remplaçant la voilure de type Marconi par des voiles plus légères et le bateau par
                une petite nacelle indépendante de la voilure.
            </p>
