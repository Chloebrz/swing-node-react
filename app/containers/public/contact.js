...
import ContactBox from "../../components/partials/boxes/contactBox";

const Contact = () => {
    return (
        <div>
            <p>
                Notre projet vous intéresse ? Vous avez une question à propos de la S'Wing ? Pour
                toute information supplémentaire, ou afin de discuter avec l'un des inventeurs,
                n'hésitez pas à nous contacter par mail dès maintenant.
            </p>
